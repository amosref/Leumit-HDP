Profile: LabTestReferralLineServiceRequest
Parent: http://fhir.health.gov.il/StructureDefinition/il-core-service-request-lab
Id: lab-test-referral-line-servicerequest
Title: "הפניה - שורות ברמת קוד"
Description: "Lab Test Referral Line serviceRequest profile"
* ^status = #draft
